...
export default function MessageItem({ message }: MessageItemProps) {
  ...
  if (isUser) {
    return (
      <div className="group w-full text-white border-b border-black/10 bg-[#343541]">
        <div className="flex gap-6 p-4 md:py-6 md:px-6 max-w-3xl mx-auto">
          <div className="flex-shrink-0 flex items-center justify-center">
            <div className="w-8 h-8 rounded-sm bg-[#c96a2f] flex items-center justify-center text-white text-sm font-semibold">
              {getUserInitials()}
            </div>
          </div>
  ...
  return (
    <div className="group w-full text-white border-b border-black/10 bg-[#444654]">
      <div className="flex gap-6 p-4 md:py-6 md:px-6 max-w-3xl mx-auto">
        <div className="flex-shrink-0 flex items-center justify-center">
        ...
        <div className="flex-1 overflow-hidden">
          ...
          <div className="flex items-center gap-2 mt-4 opacity-0 group-hover:opacity-100 transition-opacity">
            <Button
              ...
              size="sm"
              onClick={handleCopy}
              className="h-7 px-2 text-xs text-gray-400 hover:text-white hover:bg-gray-700/50 rounded"
            >
            ...
            <Button 
              variant="ghost" 
              size="sm" 
              className="h-7 w-7 p-0 text-gray-400 hover:text-white hover:bg-gray-700/50 rounded"
            >
