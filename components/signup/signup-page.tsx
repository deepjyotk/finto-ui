  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center px-6">
      <div className="max-w-md w-full rounded-2xl border border-white/10 bg-[#0F1621]/60 backdrop-blur p-8 text-center shadow-xl">
        <h1 className="text-2xl font-semibold tracking-tight">Create your ArthiQ account</h1>
        <p className="mt-2 text-sm text-[#9AA7B2]">Sign up to get started with ArthiQ</p>
        <div className="mt-6">
