export default function Testimonials() {
  const quotes = [
    ...
    {
      quote: "Risk metrics and custom calculations help me understand my portfolio better. I can ask any question and get insights instantly.",
      
      author: "Rajiv K.",
      role: "Fund manager",
    },
    {
      quote: "Arthik understands my portfolio questions naturally. I just ask what I want to know and get instant answers.",
      author: "Sunmeen B.",
