...
import { login, register, verifyOtp } from "@/lib/api/auth_api"
import { setUser, setLoading } from "@/lib/slices/auth"
import { useToast } from "@/hooks/use-toast"
import type { LoginFormData, RegisterFormData } from "@/types/auth"
import { Mail, ArrowLeft, CheckCircle2 } from "lucide-react"

const RESEND_COOLDOWN_SECONDS = 63 // 1 min 3 sec
...
export default function AuthModal({ isOpen, onClose, defaultMode = "login" }: AuthModalProps) {
  ...
  // Format cooldown time for display (show "1m Xs" format)
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      // Register user - this now sends OTP to email
      await register({
